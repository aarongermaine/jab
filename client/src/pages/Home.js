...
class Home extends React.Component {
  ...
  sendRating = (rating) => {
    ...
    return API.sendRating(this.state.user, this.state.songs[this.state.index].spotifyID, rating)
  }
      ...
      return (
        < Container fluid >
          <Row>
            <Col size="md-4"></Col>
            <Col size="md-8">
              <SongIFrame spotifyID={this.state.songs[this.state.index].spotifyID} />
            </Col>
          </Row>
          <Row>
            <Col size="md-4"></Col>
